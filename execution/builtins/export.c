...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/22 22:27:59 by augustindry       #+#    #+#             */
/*   Updated: 2023/07/23 16:10:38 by augustindry      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_export(char **args, t_env *env, t_env *env_s)
{
	int		new_env;
	int		error_ret;
